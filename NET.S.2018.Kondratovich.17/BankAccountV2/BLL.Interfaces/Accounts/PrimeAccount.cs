...
{
    public class PrimeAccount : BankAccount
    {
        public PrimeAccount(string id, string name, decimal balance, int bonusPoint, Status status) : base(id, name, balance, bonusPoint, status) { }
        ...
        protected override int CalculateBonusPoints(decimal amount) => (int)Math.Round((int)amount * 0.15);
    }
}
